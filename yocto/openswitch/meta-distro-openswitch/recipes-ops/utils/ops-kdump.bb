...
do_install_append() {
    ...
    install -c -m 755 ${WORKDIR}/ops_kdump              ${D}/usr/bin/kdump
    ...
    install -c -m 755 ${WORKDIR}/ops_core_system.conf   ${D}/etc/systemd/ops_core_system.conf
...
FILES_${PN}   +=  "/etc/systemd/system /tmp /usr/lib/sysctl.d /usr/lib/tmpfiles.d /etc/profile.d /usr/bin"
