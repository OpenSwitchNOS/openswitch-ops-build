...
do_install_append () {
      ...
      PYTHONPATH=${STAGING_DIR_TARGET}/${PYTHON_SITEPACKAGES_DIR}:${PYTHONPATH} ${PYTHON} apidocgen.py ${STAGING_DIR_TARGET}/${prefix}/share/openvswitch/unified.extschema.json > ${D}/srv/www/api/ops-restapi.json
