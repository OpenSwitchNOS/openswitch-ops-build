...
DEPENDS = "python-inflect-native python-tornado-native ops-openvswitch ops-ovsdb ops-aaa-utils ops-passwd-srv"

RDEPENDS_${PN} = "python-argparse python-json python-ops-ovsdb python-distribute python-tornado python-html python-pkgutil python-subprocess python-numbers python-inflect python-xml ops-restapi python-unixadmin python-jsonschema python-jsonpatch python-pycrypto"

SRC_URI = "git://git.openswitch.net/openswitch/ops-restd;protocol=http \
           file://restd.service \
"

SRCREV = "cb0bc72aba9b6cb3bf29dc79c813d8ff8f6bcee0"
