...
do_compile_prepend() {
    ...
    cp ${STAGING_DIR_TARGET}/usr/share/openvswitch/openswitch-idl.h ${S}/lib/openswitch-idl.h
    cp ${STAGING_DIR_TARGET}/usr/share/openvswitch/openswitch-dflt.h ${S}/lib/openswitch-dflt.h
