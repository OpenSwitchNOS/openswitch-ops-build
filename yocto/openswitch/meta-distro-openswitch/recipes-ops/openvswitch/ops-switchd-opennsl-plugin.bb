...
SRC_URI = "git://git-nos.rose.rdlabs.hpecorp.net/openswitch/ops-switchd-opennsl-plugin;protocol=http;branch=rel/dill"

FILES_${PN} = "${libdir}/openvswitch/plugins"

SRCREV = "2df3a5df0ec30291ed3fe783df1d00a9c1a7b138"
