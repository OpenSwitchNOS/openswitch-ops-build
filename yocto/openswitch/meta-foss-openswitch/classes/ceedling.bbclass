...
def ceedling_create_project_file(d):
    ...
    cCompiler = d.getVar('STAGING_BINDIR_NATIVE', True) + "/" + d.getVar('HOST_SYS', True) + "/" + cCompiler
    cLinker = get_c_linker(d)
    cLinker = d.getVar('STAGING_BINDIR_NATIVE', True) + "/" + d.getVar('HOST_SYS', True) + "/" + cLinker
