...
# These protocol names are defined in
# ops-classifierd/src/acl/util/acl_parse.c
ipv4_protocol_names = (
...
def get_ipv4_protocol_name(proto_str):
    assert isinstance(proto_str, str)
    try:
        proto_int = int(proto_str)
        return ipv4_protocol_names[proto_int]
    except ValueError:
        return proto_str
